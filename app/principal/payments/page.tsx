...
export default function PrincipalPayments() {
      ...
      <div className="p-4 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Monitor institutional finances and payment systems</p>
          </div>
        ...
        <PaymentSystem userRole="principal" />
      </div>
    </div>
  )
}
